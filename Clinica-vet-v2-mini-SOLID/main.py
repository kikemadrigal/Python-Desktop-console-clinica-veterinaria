...
from management.propietarios import Propietarios
from management.mascotas import Mascotas
from management.visitas import Visitas
from management.facturas import Facturas
from utils import *
...
def main():
    ...
    # Inicializamos los objetos con sus lista
    propietarios=Propietarios(sqliteClient)
    mascotas=Mascotas(sqliteClient)
    visitas=Visitas(sqliteClient)
    facturas=Facturas(sqliteClient)
    
    while True:
        menu_principal()
        opcion=input ("Introduce una opcion: ")
        if opcion == '1':
            menu_propietario(propietarios)
        elif opcion == '2':
            menu_mascota(mascotas, propietarios)
        elif opcion == '3':
            menu_visita(visitas)
        elif opcion == '4':
            menu_factura(facturas)
...
def menu_propietario(propietarios_manager:Propietarios):
    while True:
        print('''
                                Menu propietario
                                ----------------
        ...
        # 1. Crear propietario
        if opcion2 == '1':
            propietario=pedir_propietario(propietarios_manager)
            propietarios_manager.crear_propietario(propietario)
        ...
        #2. Modificar propietario
            ...
            pr=propietarios_manager.dame_propietarios_por_campo("dni",dni_propietario)
            if pr==None:
                print("Propietario no encontrado")
            else:
                propietario=pedir_propietario_conservando_el_que_habia(propietarios_manager,pr[0])
                propietarios_manager.modificar_propietario(propietario)
        ...
        #3. Mostrar mascotas de un propietario
            ...
            if pr==None:
                ...
                mascotas_propietario=propietarios_manager.dane_mascotas_de_un_id_propietario(pr[0].get_id())
        ...
        #4. Mostrar todos
            ...
            propietarios=propietarios_manager.get_all_propietarios()
        ...
        #5. Eliminar
            ...
            if pr==None:
                ...
                if borrar_sin_no=='s':
                    propietarios_manager.eliminar_propietario(propietario.get_dni())
...
def menu_mascota(mascotas_manager:Mascotas, propietarios):
    while True:
        print('''
                                Menu mascota
                                ----------------
        ...
        opcion2=input ("Introduce una opcion: ")
        if opcion2 == '1':
            mascota=pedir_mascota(mascotas_manager, propietarios)
            mascotas_manager.crear_mascota(mascota)
            print(mascota," anadida con éxito")
        elif opcion2 == '2':
            id_mascota=pedir_id_mascota()
            mascotas=mascotas_manager.dame_mascotas_por_campo("id",id_mascota) 
            if mascotas==None:
                print("Mascota no encontrada")
            else:
                mascota=mascotas[0]
                # Llamamos a la función dentro de esta clase que sigue con las preguntas
                mascota=pedir_mascota_conservando_la_que_habia(mascotas_manager,propietarios,mascota)
                mascotas_manager.modificar_mascota(mascota)
                ...
                tipos_agrupadas_por_raza=mascotas_manager.dame_mascotas_por_tipo_agrupadas_por_raza(tipo_introducido)
            ...
            mascotas=mascotas_manager.get_all_mascotas()
            ...
            if mascotas==None:
                ...
                if borrar_sin_no=='s':
                    mascotas_manager.eliminar_mascota(mascota.get_id())
...
def menu_visita(visitas_manager:Visitas):
    while True:
        print('''
                                Menu visita
                                ----------------
        ...
        opcion2=input ("Introduce una opcion: ")
        if opcion2 == '1':
            visita=pedir_visita(visitas_manager)
            if(visita!=None):
                visitas_manager.crear_visita(visita)
            ...
            visita=visitas_manager.dame_visita_por_id_visita(id_visita)
            if visita==None:
                print("Visita no encontrada")
            else:
                visita=pedir_visita_conservando_la_que_habia(visitas_manager, visita)
                visitas_manager.modificar_visita(visita)
        ...
        # Mostrar visitas de una mascota
            ...
            visitas_mascota=visitas_manager.dame_visitas_por_nombre_mascota(nombre_mascota)
        ...
        # 4. Mostrar todas
            ...
            visitas=visitas_manager.get_all_visitas()
            ...
            if visita==None:
                ...
                if borrar_sin_no=='s':
                    visitas_manager.delete_visita(visita.get_id())                   
...
def menu_factura(facturas_manager:Facturas):
    while True:
        print('''
                                Menu factura
                                ----------------
        ...
        opcion2=input ("Introduce una opcion: ")
        if opcion2 == '1':
            facturas=facturas_manager.get_all_facturas()
...
def pedir_propietario(propietarios:Propietarios):
    # Pide nombbre
    while True:
        ...
        if check_empty(nombre):
            ...
            continue
        if propietarios.comprobar_existe_propietario_name(nombre):
    ...
    while True:
        ...
        if not check_dni(dni):
            ...
            continue
        if propietarios.comprobar_existe_propietario_dni(dni):
...
def pedir_propietario_conservando_el_que_habia(propietarios_manager:Propietario,propietario):
    # Pide nombbre
    while True:
        nombre=input(f"Nombre: {propietario.get_nombre()}? ")
        #Lo formatemaos para tratarlo mejor sin espacios y con la 1 mayúscula
        nombre=nombre.capitalize().strip()
        if propietarios_manager.comprobar_existe_propietario_name(nombre):
            print("El propietario ya existe")
            continue
        if nombre=="":
...
def pedir_mascota(mascotas:Mascotas, propietarios:Propietarios):
    tipos_validos=mascotas.dame_tipos()
    while True:
        print("""
                            CREANDO UNA MASCOTA
            -----------------------------------------------------------------
            ...
            para sacarle el id
            """)
        mascotas_propietarios=mascotas.dame_10_primeros_mascotas_propietarios()
        ...
        dni_propietario=pedir_dni_propietario()
        pr=propietarios.dame_propietarios_por_campo("dni",dni_propietario)  
        if pr==None:
            print("Propietario no encontrado")
            continue
        id_propietario=pr[0].get_id()
        break
    while True:
...
def pedir_mascota_conservando_la_que_habia(mascotas_manager:Mascotas,propietarios:Propietarios,mascota:Mascota)->Mascota:
    tipos_validos=mascotas_manager.dame_tipos()
    while True:
        print("""
            ...
            para sacarle el id
            """)
        mascotas_propietarios=mascotas_manager.dame_10_primeros_mascotas_propietarios()
        if mascotas_propietarios==None:
            print("No hay mascotas.")
        else:
            for item in mascotas_propietarios:
        ...
        propietario=propietarios.dame_propietarios_por_campo("id",mascota.get_id_propietario())[0]
...
# VISITA
##################################################################
def pedir_visita(visitas_manager:Visitas):
    print("""
                            CREANDO UNA VISITA
            -----------------------------------------------------------------
            ...
            """)
    perimeros_id_visitas=visitas_manager.dame_10_primeros_id_de_visitas_mascotas()
    ...
    while True:
        ...
        if not is_greater_cero(id_mascota):
            ...
            continue
        if not visitas_manager.comprobar_existe_mascota(id_mascota):
...
def pedir_visita_conservando_la_que_habia(visitas_manager:Visitas, visita):
    perimeros_id_visitas=visitas_manager.dame_10_primeros_id_de_visitas_mascotas()
    if len(perimeros_id_visitas)==0:
        print("No hay visitas.")
    else:
